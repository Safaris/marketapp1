...
public class Phrase {
	...
	String subject, verb, adjective, phrase;
	
	String[] subjectsPeople = {"I", "He", "She", "We", "It", "They"};
	String[] verbs = {"fucked", "shit on", "tasted", "beat off"};
	String[] adjectives = {"all over the place.", "terrible", "great"};
	String[] phrases = {
	...
	public void generatePhrase()
	{
		...
		int s = r1.nextInt(phrases.length);
		//Random r2 = new Random();
		//int v = r2.nextInt(verbs.length);
		//Random r3 = new Random();
		//int a = r3.nextInt(adjectives.length);
		
		
		//subject = subjectsPeople[s];
		//verb = verbs[v];
